          ...
          <CardContent className="p-6 md:p-8">
            ...
            <ul className="grid gap-3 text-muted-foreground md:grid-cols-2">
              <li className="rounded-lg border border-dashed p-3">
                ✔️ Des evenements pour les alumnis
              </li>
              <li className="grid gap-3 text-muted-foreground md:grid-cols-2">
                ✔️ Des offres pour les étudiants actuels
              </li>
              <li className="rounded-lg border border-dashed p-3">
                ✔️ Un contact direct entre les anciens et l'école    
              </li>
            </ul>
